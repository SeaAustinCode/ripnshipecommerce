		...
		<div
					...
					<div class="col-md-6 d-flex">
						<div class="row">
							<div class="col-md-12 my-3 text-center text-white">
								...
								<li><strong>The Sword Shield Chilling Reign
			...
			<div class="d-flex justify-content-around container gap-5 my-5">
				<a href="/product1"><img alt="Brilliant Stars Pack"
					...
					height="400"></a> <a href="/product2"><img alt="Shining Fates Pack"
					src="/images/shining_fates_pack_charizard.jpg" width="245" height="400"></a>
			</div>
