	...
	<div class="col-12 d-flex border border-yellow"
		...
		<div
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 d-flex justify-content-center">
						<img src="/images/brilliant_stars_pack.jpg" width="245"
							height="400" alt="Single Brilliant Stars Booster Pack">
					</div>
					<div class="col-md-6 d-flex">
						<div class="row">
							<div class="col-md-12 my-3 text-center text-white">
								<h1>Brilliant Stars - single pack</h1>
								<h2 class="text-center my-3">$6.00</h2>
									<a href="/cart">
									<button class="btn btn-light btn-lg btn-outline-primary w-40 mx-auto">Add to Cart<%-- <c:out value="${cart.products.size()}" /> --%></button></a>
								<h3 class="my-4">About this item</h3>
								<li><strong>The Sword Shield 06 Chilling Reign
			...
			<div class="d-flex justify-content-around container gap-5 my-5">
				<a href="/product2"><img alt="Shining Fates Pack"
					src="/images/shining_fates_pack_charizard.jpg" width="245"
					height="400"></a> <a href="/product3"><img
					alt="Chilling Reign Pack" src="/images/chilling_reign_pack.jpg"
